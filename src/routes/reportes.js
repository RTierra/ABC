...
router.get('/reportes/todos', async (req, res) => {
    ...
    const transaccions = await Transaccion.find({date:date});
...
router.get('/reportes/todos/mes', async (req, res) => {
    ...
    //Transacciones de la base de datos
    const transaccions = await Transaccion.find({date_ma:date_ma});
...
router.post('/reportes/todos', async (req, res) => {
    ...
    //Transacciones de la base de datos
    const transaccions = await Transaccion.find({date:title});
...
router.get('/reportes/BcoPichincha', async (req, res) => {
  //Transacciones de la base de datos
  const transaccions = await Transaccion.find({entidad:"Pichincha", date:date});
...
router.get('/reportes/BcoPichincha/mes', async (req, res) => {
    //Transacciones de la base de datos
    const transaccions = await Transaccion.find({entidad:"Pichincha", date_ma:date_ma});
...
router.post('/reportes/BcoPichincha', async (req, res) => {
    ...
    //Transacciones de la base de datos
    const transaccions = await Transaccion.find({entidad:"Pichincha", date:title});
...
router.get('/reportes/Full-carga', async (req, res) => {
    //Transacciones de la base de datos
    const transaccions = await Transaccion.find({entidad:"Full-carga", date:date});
...
router.get('/reportes/Full-carga/mes', async (req, res) => {
    //Transacciones de la base de datos
    const transaccions = await Transaccion.find({entidad:"Full-carga", date_ma:date_ma});
  ...
  router.post('/reportes/Full-carga', async (req, res) => {
    ...
    //Transacciones de la base de datos
    const transaccions = await Transaccion.find({entidad:"Full_carga", date:title});
